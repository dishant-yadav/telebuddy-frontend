...
const SignUp = () => {
	...
	return (
		<section className='flex justify-center items-center h-screen w-screen bg-[#64aad7]'>
			<div className='flex flex-col gap-4 justify-center items-center w-[420px] h-[450px] bg-white rounded-lg'>
				...
				<form
					...
					<button type='submit' className=' w-full rounded bg-[#64aad7] mt-4 px-2 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600'>
						SignUp
					</button>
				</form>
			</div>
